(function() {
	...
	var factory = function (exports) {
		...
		var $             = jQuery;
		var pluginName    = "blog-file";

		exports.fn.blogFile = function() {
			var _this       = this;
			var cm          = this.cm;
			...
			createFolderModal += '<label for="name" class="control-label">名称(1~20个字符):</label> <input type="text" class="form-control" name="name"><input type="text" class="form-control" style="display:none">';
			createFolderModal += '</div>';
