...
CREATE TABLE IF NOT EXISTS `blog_comment_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `blog_oauth_bind` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `blog_oauth_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `blog_space_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
