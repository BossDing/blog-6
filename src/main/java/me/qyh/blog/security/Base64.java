...
public final class Base64 {
	 ...
	 * .org/rfcs/rfc3548.html</a>. It is important to note that data encoded
	 * this way is <em>not</em> officially valid Base64, or at the very least
	 * should not be called Base64 without also specifying that is was encoded
